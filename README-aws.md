...
1. Install all required tools and set your own AWS credentials and vars. Don't forget to update the **_PREFIX_** to your namespace and the **_TAG_VALUE_** to your email.
...
7. Deploy NGINX+ IC to EKS. Take note of your **_NGINX service URL_**.
...
8. Deploy ArgoCD to EKS. Take note of your ArgoCD **_admin password_** and **_service URL_**. There will be only one instance of ArgoCD.
...
- [nap-vs.yaml](app/nap-vs.yaml) update the _host_ to your NGINX service URL.
- [nap-waf-policy.yaml](app/nap-waf-policy.yaml) update the _responsePageReference_ and _whitelistIpReference_ links to your repo.
- [scan.yaml](workflows/scan.yml) update the _target_ to your NGINX service URL.
